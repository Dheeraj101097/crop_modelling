              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-600">research@soybean-ml.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-green-800 font-medium">Phone</p>
                    <p className="text-green-600">+91 XXX XXX XXXX</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-600">Bundelkhand, India</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-yellow-50 p-8 rounded-3xl shadow-lg">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <p className="text-green-800 font-medium">GitHub Repository</p>
                    <p className="text-green-600 text-sm">View source code and data</p>
                  </div>
                </motion.a>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-green-600">
              © 2024 Soybean Yield Prediction Research Project. Built with passion for sustainable agriculture.
            </p>
          </div>
        </div>
      </footer>
